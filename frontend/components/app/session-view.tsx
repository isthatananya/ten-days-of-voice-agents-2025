  ...
  return (
    ...
    >
      ...
      >
        ...
        <ScrollArea ref={scrollAreaRef} className="px-4 pt-40 pb-[150px] md:px-6 md:pb-[180px] flex justify-center">
          <ChatTranscript
            hidden={!chatOpen}
            messages={messages}
            className="max-w-lg space-y-3 transition-opacity duration-300 ease-out"
          />
        </ScrollArea>
      </div>
      ...
      <MotionBottom
        ...
        className="fixed inset-x-3 bottom-0 z-50 md:inset-x-12 flex justify-center"
      >
        {appConfig.isPreConnectBufferEnabled && (
          <PreConnectMessage messages={messages} className="pb-4" />
        )}
        
        <div className="relative max-w-lg pb-3 md:pb-12">
